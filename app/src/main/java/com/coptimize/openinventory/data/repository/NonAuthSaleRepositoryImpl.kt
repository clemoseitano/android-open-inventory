...
import com.coptimize.openinventory.data.GetSalesWithItemsInRange
...
class NonAuthSaleRepositoryImpl @Inject constructor(
            ...
            try {
                ...
                db.transaction {
                    ...
                    cart.items.forEach { cartItem ->
                        ...
                        db.productQueries.decrement(quantity_change=cartItem.quantity.toLong(), productId=cartItem.productId)
                    }
